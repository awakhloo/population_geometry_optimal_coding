...
area='PFC' ##### SET TO 'PFC' or 'CA1' DEPENDING ON WHICH AREA YOU WANT TO ANALYZE!
...
ns = 50 # neural subsets. can set this to a much smaller value (eg 15) and still get good results in a fraction of the time.  
